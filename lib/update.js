...
exports.registry = function updateRegistry(release){
  return release.initialManifest.get('private')
  ? null
  : utils.cproc.execAsync('npm publish')
}
...
exports.localVCS = function updateLocalVCS(release){
  ...
  .then(function(){
    return utils.cproc.execAsync('git tag ' + release.version)
  })
}

exports.manifest = function updateManifest(release){
  return utils.updateJSONData(utils.getManifestFilepath(), { version: release.version })
}
